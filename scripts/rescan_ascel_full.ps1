...
& "C:\Program Files\Python311\python.exe" scripts\rescan_ascel_full.py 2>&1 | Out-File -FilePath reports\rescan_ascel_full.txt -Encoding utf8
Write-Output 'Full rescan finished. Restarting daemon...'
